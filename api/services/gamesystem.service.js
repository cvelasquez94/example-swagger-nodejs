...
const getGameSystems = params => gamesystemRepository.getGameSystems(params);
const getGameSystemById = id => gamesystemRepository.getGameSystemById(id);
const getGameSystemByName = name => gamesystemRepository.getGameSystemByName(name);
const createGameSystem = (params) => {
